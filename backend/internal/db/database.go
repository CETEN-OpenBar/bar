...
type DBackend interface {
	...
	GetAccounts(ctx context.Context, role string, priceRole string, page uint64, size uint64, query string) ([]*models.Account, error)
	CountAccounts(ctx context.Context, role string, priceRole string, query string) (uint64, error)
