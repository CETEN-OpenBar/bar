...
<div id="popup" class="absolute w-full h-full flex justify-center items-center">
	<!-- Put a title and the numpad -->
	<div class="flex flex-col items-center bg-white rounded-lg shadow-lg p-4 z-20">
		<h1 class="text-2xl font-bold mb-4">Entrez votre code pin</h1>
